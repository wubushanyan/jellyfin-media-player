set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Terminus Player")
set(CPACK_PACKAGE_VENDOR "Jellyfin")
set(CPACK_PACKAGE_NAME "Terminus Player")
...
set(CPACK_PACKAGE_FILE_NAME "TerminusPlayer-${VERSION_STRING}-${CPACK_SYSTEM_NAME}")
set(CPACK_SOURCE_PACKAGE_FILE_NAME "TerminusPlayer-${VERSION_STRING}-src")

set(CPACK_PACKAGE_INSTALL_DIRECTORY "TerminusPlayer")
...
if(WIN32)
  ...
  include(CPack)
  cpack_add_component(Core DISPLAY_NAME "Terminus Player" DESCRIPTION "Terminus Player (Core Application)" REQUIRED)
endif(WIN32)